...
export default class CreateQuestion extends Component {
  constructor(props) {
    super(props);
    this.state = {
      // if a non-null question is provided as input, it gets set in the state
      // otherwise, a new question is created
      question: props.question ? Object.assign({}, props.question.question) : {
      ...
      answers: props.question ? Object.assign({}, props.question.answers) : [],
    }
  ...
  resetForm() {
    this.setState({
      question: this.props.question ? Object.assign({}, this.props.question.question) : {
        bookId: this.props.book.id,
        userId: AuthService.getCurrentUser().id,
        numberOfAnswers: "",
        numCorrectAnswers: "",
      ...
      answers: this.props.question ? Object.assign({}, this.props.question.answers) : [],
    });
    this.form.reset();
        ...
        >
            ...
            <div className="form-group col-md-6 mb-2">
              ...
              >
                  ...
                  {[...Array(sys.MSG_NO_QUESTION_CATEGORIES).keys()].map(idx =>
                  (
            ...
            <div className="form-group col-md-6 mb-2">
              ...
              <select className="form-select required" 
                      ...
                      disabled={this.props.question} //number of answers can only be set for a new question 
            ...
            {(numberOfAnswers === 4) ? (
              <div className="form-group col-md-6 mb-2">
                ...
                <select className="form-select required" 
                        ...
                        required
                        disabled={this.props.question} //number of correct answers can only be set for a new question 
